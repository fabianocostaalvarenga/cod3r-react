        ...
        return(
            <form role='form' onSubmit={ handleSubmit } >
                <div className='box-body'>   
                    ...
                    <ItemList title='Créditos' field='credits' cols='12 6' list={credits} readOnly={readOnly}/>
                    <ItemList title='Débitos' field='debts' cols='12 6' list={debts} readOnly={readOnly} showStatus={true}/>
                </div>
